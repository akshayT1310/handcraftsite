...
urlpatterns = [
    ...
    path('profile/update-phone/', views.update_phone),

    # Cart
    path('cart/', views.cart_view),
    path('add-to-cart/<int:product_id>/', views.add_to_cart),
    path('update-cart/<int:item_id>/<str:action>/', views.update_cart),
    path('remove-item/<int:item_id>/', views.remove_from_cart),
    ...
    path('products/manage/', views.product_list_admin),
    ...
    # Admin orders
    path('orders/manage/', views.admin_orders_list),
